...
public class DaterImpl extends JFrame {
	...
	public DaterImpl() {
		...
		try{
			...
			txtFirstName.setText(daterData.getRecordNumber(recordNum).getFirstName());
			txtFirstName.setBounds(142, 5, 194, 26);
			contentPane.add(txtFirstName);
			txtFirstName.setColumns(10);
			
			txtGender = new JTextField();
			txtGender.setText(daterData.getRecordNumber(recordNum).getGender());
			...
			txtAge.setText(daterData.getRecordNumber(recordNum).getAge());
			...
			txtCompany.setText(daterData.getRecordNumber(recordNum).getCompany());
			...
			txtCity.setText(daterData.getRecordNumber(recordNum).getCity());
			...
			txtEmail.setText(daterData.getRecordNumber(recordNum).geteMail());
			...
			txtFavouriteColour.setText(daterData.getRecordNumber(recordNum).getFavColour());
			...
			txtSurname.setText(daterData.getRecordNumber(recordNum).getFamilyName());
			...
			txtRace.setText(daterData.getRecordNumber(recordNum).getRace());
			...
			txtJobTitle.setText(daterData.getRecordNumber(recordNum).getJobTitle());
			...
			txtSmokes.setText(daterData.getRecordNumber(recordNum).getSmokes());
			...
			txtPets.setText(daterData.getRecordNumber(recordNum).getHasPets());
			...
			txtWantsKids.setText(daterData.getRecordNumber(recordNum).getWantsKids());
			...
			txtHasKids.setText(daterData.getRecordNumber(recordNum).getHasKids());
